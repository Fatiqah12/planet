          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo e(route('latihan')); ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Cipta Latihan</p>
                    </a>
                  </li>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="pages/tables/simple.html" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Permohonan Latihan</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="pages/tables/data.html" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Senarai Permohonan Latihan</p>
                    </a>
                  </li>
                </ul>
              </li>
...
<?php /**PATH C:\xampp\htdocs\planet\resources\views/layouts/admin.blade.php ENDPATH**/ ?>